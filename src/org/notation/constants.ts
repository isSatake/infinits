...
export const upFlagMap = () =>
  new Map<Duration, FlagUp>([
    [8, bFlag8Up()],
    [16, bFlag16Up()],
    [32, bFlag32Up()],
  ]);

export const downFlagMap = () =>
  new Map<Duration, FlagDown>([
    [8, bFlag8Down()],
    [16, bFlag16Down()],
    [32, bFlag32Down()],
  ]);

export const restPathMap = () =>
  new Map<Duration, RestPath>([
    [1, bRest1()],
    [2, bRest2()],
    [4, bRest4()],
    [8, bRest8()],
...
export const accidentalPathMap = () =>
  new Map<Accidental, Path>([
